    ...
    \rowcolors{1}{white}{shadecolor}
      ...
      %\hline
	   ...
	   Kunde involvering 		
	   		...
	   		& Vi kan selv finde kravene og danne user stories, og har derfor svært ved at have en Product Owner, så vi skal selv styre product backlog på gruppen istedet.\\
	   ...
	   Kommunikationsmetoder	
	   		...
	   		& Scrum master rollen kan gå på runde fra sprint til sprint eller fra uge til uge. Review meeting kan holdes uden kunder, og fungerer som et godt tidspunkt at gennemgå koden sammen med resten af gruppen. \\
    \end{tabular}
