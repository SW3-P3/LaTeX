...
De to perspektiver munder ud i hver deres udviklingsmetode; henholdsvis konstruktion og evolution, som håndterer problemer efter hvert sit perspektiv.\citep{OOA&D2001} \fxnote{Det kommer altså ikke fra den bog\, det kommer fra en artikel vi havde i faget\, det skal lige skrives om så det ikke nævner OOA\&D}
...
Til dette blev valgt at benytte Scrum, beskrevet på \myref{scrum}. med det primære formål at benytte sig af Scrum Task Board til uddelegering af opgaver, såvel som Daily Scrum; dette medførte at ingen gruppemedlemmer var i tvivl om, hvad der blev arbejdet på.
...
Ud fra dette ``dependency tree'' blev der oprettet en prioritering for hvilke user stories (kan ses på \myref{sec:krav}), der skulle udvikles først.
...
Der kan laves et scrumboard\fxnote{DailyTaskBoard eller Scrumboards?} for at holde styr på hvilke opgaver, der skal laves til hver enkelt user story. 
