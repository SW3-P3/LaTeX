...
Ud fra dette ``dependency tree'' blev der oprettet en priotering for hvilke user stories (kan ses på \myref{sec:krav}), der skulle udvikles først.
...
Det valgte værktøjer blev således, for organisering af opgaver, at benytte sig af Sprints.
