...
Komponentdiagrammet på \myref{figure:komp} viser hvilke sektioner af systemet, der kunne udvikles parallelt, og hvilke der var afhængige af andre sektioner, før udvikling ville være en mulighed.
Ud fra dette blev der oprettet en prioritering for, hvilke user stories, der skulle udvikles først, disse kan ses i kravspefikationen i \myref{sec:krav}.
...
Gruppen laver ændringer på den traditionelle Scrum process for at tilpasse det til projektet; disse kan håndteres og ændres, som \myref{tabel:sammenligningstabel} også viser.
