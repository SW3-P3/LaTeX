...
Tilbudsaviser kan tilgås på, hvilket kan ses på \myref{ss:eTilbudsavis} hvor der er mulighed for at sætte en præference på, hvor store en radius man vil lede efter sagte tilbudsavis.
Under hver af avis som ses på figuren er der også afstand i menter, fra ens aktuelle placering. 
...
\begin{figure}
	\centering
		\includegraphics[scale=0.35]{images/Images/eTilbudsavis.PNG}
...
Tilbudsugen er et lidt dårligere alternativt til eTilbudsavis, da der er problemer med deleingen af indkøbslisterne, samt den app der er stillet til rådighed ikke er stabil.
...
\input{images/Tables/SOTA_apps.tex}
...
\begin{figure}
	\centering
		\includegraphics[scale=0.15]{images/Images/MinFakta.png}
	\caption{Tilbudsaviser på eTilbudsavis.dk}
	\label{ss:MinFakta}
\end{figure}
Faktas android app kalder de for ``Mit fakta'', den er som helhed overskuelig.
Efter åbning af appen har man mulighed for seks menupunkter og at ændre sine indstillinger, disse kan ses på \myref{ss:MinFakta}.
