...
\section{Hændelser}
Vi har analyseret de forskellige hændelser der sker i problemområdet. \fxnote{Hvor har vi gjort det :D ?} \fxfatal{evt. ``Vi har fundet frem til [..]''} 
...
Denne information bruges som udgangspunkt til at lave tilstandsdiagrammer over systemet, klassediagram såvel som hændelsesforløb og adfærdsmønstre for diverse klasser, hvilket i sidste ende giver en beskrivelse af systemets overordnede struktur form af adfærdsmønstre samt attributter for klasserne i klassediagrammet.