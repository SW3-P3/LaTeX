...
% Website first
For at tilgå overvågningslisten trykker brugeren på \class{Overvågningsliste} i menubaren øverst på hjemmesiden.
...
En overvågnignsliste er tilsluttet en bruger som et felt af typen \class{ShoppingList} og navnet \class{WatchList}. %Watchlist er det en liste af ure?
Denne shoppinglist bliver oprettet når brugeren bliver oprettet.
I databasen, bliver overvågningslistens id gemt i tabellen Users, og får sit navn \class{watchList} i tabellen \class{ShoppingLists}.

For at kunne sende e-mails til brugerene når varerne på deres overvågningsliste kommer på tilbud er metoden \class{NotifyWatchers} lavet i \class{OfferControler.cs} som ses på \myref{notifywatcherlisting}. 
...
\end{lstlisting}
I \myref{notifywatcherlisting} bliver alle brugernes indkøbslister gennemløbet og tjekket mod listen over tilbud, som er blevet sent til brugeren (\class{SentOffers}). 
