...
En overvågningsliste er tilsluttet en bruger som et felt af typen \class{ShoppingList} og navnet \class{WatchList}. 
...
\end{lstlisting}
I \myref{notifywatcherlisting} bliver alle \class{User}s \class{ShoppingList}s gennemløbet og tjekket mod listen over tilbud, som allerede er blevet sendt til denne \class{User} (\class{SentOffers}). 
Hvis der eksistere \class{Offer}s som ikke allerede er sendt til en \class{User}, som passer til \class{Item}s på deres \class{WatchList}, så vil en e-mail, indeholdende de nævnte tilbud, blive sendt til dem. 
