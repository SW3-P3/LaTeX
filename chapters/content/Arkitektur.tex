...
\textit{Opskriftskomponenten} er afhængig af brugerkomponenten, da det er brugerene i systemet der tilføjer opskrifter, samt giver opskrifterne en vurdering.
...
Der er desuden for at teste programmet udviklet et administrationspanel, i \class{AdminController.cs}. Der er forskellige funktioner heri som gør det muligt at ændre systemtiden i programmet, hente tilbud ind via JSON data gemt i en lokal fil, og meget mere som også ændre på dataene der findes i databasen.
