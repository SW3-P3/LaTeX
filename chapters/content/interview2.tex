...
Således ville en overgang til en ny løsning her være mere naturlig end de ældre grupper, der ofte laver listen på papir og har bøger med opskrifter til at finde inspiration.\fxnote{How do we know this? - Søren}
På trods af dette var der stadig en interesse i den ældre gruppe, og målgruppen er som følge deraf ikke udelukkende unge.

Den 2. runde af interviews blev udført som semi-strukturerede interviews, med personer hvor der var oprettet kontakt på forhånd, frem for at finde fremmede på gaden.
Dette tillod os at interviewe i længere tid, såvel som at de interviewede i forvejen var forberedt på et interview.
Et semi-struktureret interview tillader at der afviges fra de nedskrevne spørgsmål, for at følge samtalen og stille uddybende spørgsmål omkring potentielle kommentarer.\fxnote{Find eventuel kilde fra DEB? - Marc}
...
Et dokument over de strukturerede spørgsmål af interview-sessionerne, kan findes i \myref{ch:PrototypeInterview}. %Interview2.
...
\begin{itemize}
	...
	\item Opskrifter, som gør brug af tilbud. \fxnote{Dette gør vi ikke - Søren}
	...
	\item Filtrering under opskrifter, så man kan se hvad man kan lave ud af f.eks. oksekød osv. \fxnote{Det fik vi aldrig lavet - Søren}
...
En oversigt over de adspurgtes svar såvel som forslag, kan ses i \myref{ch:protorespons}%Interview2 Opsummering
