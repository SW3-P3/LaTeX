...
Ud fra systemdefinitionen på \myref{Sysdef} ved vi at systemet skal holde styr på følgende:
...
Indkøbslisterne kan deles mellem flere brugere, og derfor skal koblingen på personenklassen ikke være singulær, men altså 1..*. \fxnote{Dette har vi ikke nævnt ved de ovenstående eksempler. Er det fint? Eller skal det evt. slettet hvilken kobling der er?}

\subsection{Hændelser}\label{handelser}
På baggrund af de nævnte funktionaliteter i prototype interviewene (\myref{section:interview2}), er der opnået forskellige hændelser, relevante for funktionaliteterne.
