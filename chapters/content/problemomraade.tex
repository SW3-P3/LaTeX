...
Denne overstående analyse vil hjælpe til at designe systemets implementering, førts foretages dog en analyse af anvendelsesområdet, hvilket yderligere vil bidrage til den endelige implementation. 
