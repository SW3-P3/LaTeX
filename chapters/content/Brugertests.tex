...
\begin{enumerate}
   ...
   \item \textbf{Tilbud}\begin{itemize}
   								  \item Flere var i tvivl om hvorvidt tilbuddene var aktuelle på tidspunktet programmet blev anvendet, således kunne en informativ tekst omkring tilbuddene tilføjes til denne sektion af systemet, for at give brugeren mere præcis information, om hvad der ses på skærmen.
   								  \item En anden ønsket funktionalitet var at vare blev katagoriseret, eksempelvis som mejeri, pålæg, kød osv. Dette problem er desvære ikke løsbart med den valgte løsning.
   ...
   \item \textbf{Opskrifter}\begin{itemize}
   								  ...
   								  En mindre gruppe ønskede yderligere at der ligeledes kunne fjernes vare fra sin inkøbsliste, igennem opskrift sektionen af systemet.
...
Som følge af disse resultater, kan systemet udvikles og ændres, til at være mere brugervenligt og indbyddende for den primære målgruppe.
De testede blev sammentidig spurgt en række opfølgende spørgsmål omkring brugen af systemet, her var den generelle konsensus at systemet virkede som et let at benytte og brugbart system, hvorfor der var en interesse.