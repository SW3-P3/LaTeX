...
De testede komponenter består af komponenterne beskrevet i \myref{subsec:komp}, detter er altså filerne: ``RecipesController'', ``ShoppingListsController'', ``OfferController'', ``UserController'',  og en lille del af ``AccountController''.
