...
Herefter gennemgås design og implementation for brug af eTilbudsavis' API, til sidst konkluderes samles alt dette op i en konklusion.
...
\subsection{Konklusion} \fxnote{This sux, men jeg ved ikke hvad jeg skal skrive i konklusionen - Troels}
