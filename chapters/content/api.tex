...
Dette API udbydes af den danske virksomhed eTilbudsavis.dk, og er af typen Representational state transfer (REST).

\subsection{Teori}
REST er en arkitektur anvendt over HTTP(S) standarden. 
