...
Der bruges HTTP status koderne \class{2xx} som en sucess, \class{3xx} som en vidresendelse, \class{4xx} som en klient fejl og \class{5xx} som en serverfejl. 
Eksempelvis på dette kunne være \class{200 OK} som viser at alt er sket i henhold til efterspørgslen, samt at datet er leveret. 
