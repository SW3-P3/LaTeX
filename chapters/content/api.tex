...
Foruden dette er det også muligt at importere tilbud direkte fra JSON-filer, dette sker via metoden ``ImportOffersFromFiles'' fra controlleren ``AdminPanelController.cs''.
Denne metode henter filer fra stien ``ProjectFood/App_Data/jsonData/'', og oversætter dem til instanser af klassen Offer og tilføjer dem til databasen. 
