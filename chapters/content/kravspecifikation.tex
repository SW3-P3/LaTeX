...
Følgende user stories er baseret på brugsmønstrene og funktionerne fra analysen af anvendelsesområdet i \myref{sec:anvendelses}, samt svarene fra de interviewede, og vil blive designet og implementeret i systemet.
...
Der stilles yderligere krav til projektet og systemet, bl.a. fra funktionaliteter fundet i \myref{subsec:funktioner} om funktioner, og fra studieordningen.
\begin{enumerate}
