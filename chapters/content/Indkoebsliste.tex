...
Dette skyldes bl.a. det mangelfulde data som beskrevet i \myref{api:skoddata}.
En bedre implementering kunne laves, hvis der f.eks. fandtes kategorier på tilbudene, samt generiske varer.
Som brugertestene viser, i \myref{ss:bt2}, fungerer implementeringen for slutbrugeren trods disse mangler.
