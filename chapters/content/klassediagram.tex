...
\begin{figure}[h!]
\centering
 \includegraphics[trim=1.4cm 6.1cm 6.5cm 1.8cm, clip, width=1\textwidth]{/Diagrams/PFClasses_2.pdf} % trim=4.85cm 15cm 0.85cm 1cm
...
I struktur, \myref{sec:struktur}, blev anbefaling oprettet som en klasse, i vores implementering fungerer anbefaling som en sortering af viste opskrifter, læs mere om dette i \myref{anbefaling} om anbefaling.

I de følgende afsnit, vil der gives en gennemgang af udvalgte dele af komponenterne fra \myref{subsec:komp}, om komponenter.
