...
For en yderligere beskrivelse af de funktionaliteter i systemet, som vedrører en given aktør, modelleres en række brugsmønstre lavet på baggrund af hændelserne repræsenteret på \myref{handelser}, dette er de samme brugsmønstre som ses i \myref{aktortabel}.
